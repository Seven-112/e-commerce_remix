...
import StepOne from "~/routes/onboarding/step-1";
import OTP from "~/routes/onboarding/step-2/request-otp";
import StepTwo from "~/routes/onboarding/step-3";
import VerifyOTP from "~/routes/onboarding/step-2/verify-otp";
